...
public class C02_Concatenation {
    public static void main(String[] args) {
        ...
        System.out.println(str1 + " "+ str2+ " "+sayi1+sayi2);//Java Güzeldir 54 yapalım
        System.out.println(str1+ " "+ str2+ " "+ (sayi1+sayi2));//Jacva güzeldir 9 yazdıralım
        ...
        str1.concat(str2);//javaGuzeldir yapar
